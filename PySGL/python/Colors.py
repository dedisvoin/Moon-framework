"""
Мощный модуль для работы с цветами в PySGL
Автор: Павлов Иван (Pavlov Ivan)
Версия: 1.3.0
Дата последнего обновления: 2025-07-20
Лицензия: MIT
### Реализованно на 100% 
...
- Манипуляций с цветами (RGB, RGBA)

- Создания сложных градиентов

- Генерации гармоничных цветовых палитр

- Конвертации между цветовыми моделями

- Визуализации цветовых схем

== Основные возможности ==========================================

✓ Класс Color с 30+ методами работы с цветом

✓ 30+ предустановленных цветов (COLOR_RED и др.)

✓ 7 схем генерации палитр (аналогичные, триадные и др.)

✓ 3 типа градиентов (линейные, с настраиваемыми точками)

✓ Поддержка альфа-канала прозрачности

✓ Инструменты осветления/затемнения цветов


== Примеры использования =========================================

from color_tools import Color, generate_palette

# Создание цвета
blue = Color(0, 0, 255)

# Генерация палитры
palette = generate_palette(blue, scheme='triadic', num_colors=5)

# Осветление цвета
light_blue = blue.lighten(0.3)
...
COLOR_ALPHA: Final[Color] = Color(0, 0, 0, 0)
# /////////////////////////////////////////////////////
